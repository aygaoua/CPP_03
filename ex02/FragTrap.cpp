...
/*   Updated: 2024/02/03 21:07:43 by azgaoua          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void FragTrap::attack(const std::string& target) {
	if (_Hit_points > 0 && _Energy_points > 0) {
		...
		std::cout << "FragTrap " << _Name << " have zero Energy points and zero Hit points" << std::endl;
...
void 			FragTrap::highFivesGuys() {
	std::cout << "High fives from the FragTrap " << _Name << \
					" to all the Guys :)" << std::endl;
}
/*----------------------------------------------------------------------------*/
